...
import static com.whiteowl.client.kite.KiteConstant.URL_HOLDINGS;
...
public class HoldingsRequest extends Get {

	public HoldingsRequest(@NonNull final KiteSession kiteSession) {
		super(URL_BASE + URL_HOLDINGS, TIMEOUT, TIMEOUT);
