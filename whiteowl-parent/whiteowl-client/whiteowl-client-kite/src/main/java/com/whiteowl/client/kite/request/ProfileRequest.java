...
import static com.whiteowl.client.kite.KiteConstant.URL_PROFILE;
...
public class ProfileRequest extends Get {

	public ProfileRequest(@NonNull final KiteSession kiteSession) {
		super(URL_BASE + URL_PROFILE, TIMEOUT, TIMEOUT);
