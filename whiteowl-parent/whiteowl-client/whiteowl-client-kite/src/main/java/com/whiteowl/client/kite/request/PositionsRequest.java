...
import static com.whiteowl.client.kite.KiteConstant.URL_POSITIONS;
...
public class PositionsRequest extends Get {

	public PositionsRequest(@NonNull final KiteSession kiteSession) {
		super(URL_BASE + URL_POSITIONS, TIMEOUT, TIMEOUT);
