...
public class NseIndexPopulator implements IndexPopulator {
	...
	private String resolveUrl(Index index) {
		switch(index) {
		case NIFTY50 : return "https://www1.nseindia.com/content/indices/ind_nifty50list.csv";
		case NIFTYNEXT50: return "https://www1.nseindia.com/content/indices/ind_niftynext50list.csv";
