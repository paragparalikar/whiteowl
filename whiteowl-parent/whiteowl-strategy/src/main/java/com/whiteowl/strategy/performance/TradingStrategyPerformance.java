...
public class TradingStrategyPerformance {
	...
	public String toString() {
		...
		builder.append("netHoldingBarCount                ").append(String.valueOf(netHoldingBarCount)).append(lineSeparator);
		...
		builder.append("netLossAmount                     ").append(numberFormat.format(netLossAmount)).append(lineSeparator);
		builder.append("netProfitAmount                   ").append(numberFormat.format(netProfitAmount)).append(lineSeparator);
		builder.append("netProfitLossAmount               ").append(numberFormat.format(netProfitLossAmount)).append(lineSeparator);
		builder.append("buyAndHoldProfitLossAmount        ").append(numberFormat.format(buyAndHoldProfitLossAmount)).append(lineSeparator);
		...
		builder.append("averageLossAmount                 ").append(numberFormat.format(averageLossAmount)).append(lineSeparator);
		builder.append("averageProfitAmount               ").append(numberFormat.format(averageProfitAmount)).append(lineSeparator);
		builder.append("averageProfitLossAmount           ").append(numberFormat.format(averageProfitLossAmount)).append(lineSeparator);
		...
		builder.append("maxLossAmount                     ").append(numberFormat.format(maxLossAmount)).append(lineSeparator);
		builder.append("maxProfitAmount                   ").append(numberFormat.format(maxProfitAmount)).append(lineSeparator);
		...
		builder.append("maxDrawdownAmount                 ").append(numberFormat.format(maxDrawdownAmount)).append(lineSeparator);
		builder.append("maxDrawdownPercentage             ").append(numberFormat.format(maxDrawdownPercentage)).append(lineSeparator);
		builder.append("riskFreeReturn                    ").append(numberFormat.format(riskFreeReturn)).append(lineSeparator);
