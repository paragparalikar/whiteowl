...
import com.whiteowl.scripting.screener.BreakoutScreen;
...
import com.whiteowl.scripting.screener.ScreenerListener;
import com.whiteowl.scripting.screener.ScreenerService;
...
public final class ScreenerPane extends VBox implements ScripNavigable {
    ...
    public ScreenerPane(ScripRepository scripRepository, BarsRepository barsRepository,
                        ...
                        com.whiteowl.scripting.script.ScriptRepository screenerScriptRepo) {
        this.screenerService = new ScreenerService(scripRepository, barsRepository);
        this.screenRegistry = new ScreenRegistry(screenerScriptRepo, List.of(new BreakoutScreen()));
