...
@Slf4j
public final class ScriptedSubChartIndicator implements SubChartIndicator {
    ...
    public ScriptedSubChartIndicator(GroovyIndicator groovyIndicator,
    ...
    public SubChartResult compute(Bars bars, Map<String, Object> settings) {
        try {
            ...
            return new SubChartResult(doubles, Color.WHITE, label, true, List.of(), null, null, null);
        } catch (Exception e) {
            ...
            return new SubChartResult(empty, Color.WHITE, groovyIndicator.getName(), true, List.of(), null, null, null);
        }
    }
