...
import static com.whiteowl.workbench.collection.ObservableListMerger.merge;
...
import com.whiteowl.workbench.review.model.AutofixContext;
import com.whiteowl.workbench.review.model.ReviewConfig;
import com.whiteowl.workbench.review.model.ReviewFinding;
import com.whiteowl.workbench.review.model.ReviewFindingCode;
import com.whiteowl.workbench.review.service.AccountReviewService;
...
public final class OrderBookPanel extends VBox {
    ...
    private TableView<ReviewFinding> buildReviewTable() {
        ...
        selectAllCheckBox.setOnAction(e -> reviewData.forEach(
                f -> f.setSelected(selectAllCheckBox.isSelected())));
        TableColumn<ReviewFinding, Boolean> selectCol = new TableColumn<>();
        selectCol.setGraphic(selectAllCheckBox);
        selectCol.setCellValueFactory(c -> new SimpleBooleanProperty(c.getValue().isSelected()));
        selectCol.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Boolean selected, boolean empty) {
                ...
                if (empty) {
                    ...
                    checkBox.setSelected(finding.isSelected());
                    checkBox.setOnAction(e -> finding.setSelected(checkBox.isSelected()));
                    setGraphic(checkBox);
                }
            }
        });
        ...
        clearBtn.setOnAction(e -> reviewData.removeIf(ReviewFinding::isSelected));
    ...
    private void autofixSelected(Button button) {
        ...
        List<ReviewFinding> selected = reviewData.stream()
                .filter(ReviewFinding::isSelected)
