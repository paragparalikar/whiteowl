...
public final class StatusBar extends HBox {
    ...
    private final Label liveIndicator;
    ...
    public StatusBar(ActiveAccountManager accountManager, AccountService accountService) {
        ...
        this.liveIndicator = buildLiveIndicator();
        ...
        getChildren().addAll(toastLabel, spacer, liveIndicator, orderBookButton, accountPill);
    ...
    public void setLiveStreaming(boolean live) {
        Platform.runLater(() -> liveIndicator.setVisible(live));
    }

    private Label buildLiveIndicator() {
        Label label = new Label("LIVE");
        label.setStyle("-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-padding: 2 6; "
