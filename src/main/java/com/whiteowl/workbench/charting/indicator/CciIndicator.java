...
public final class CciIndicator implements SubChartIndicator {

    private static final String INDICATOR_NAME = "CCI";
    private static final String PERIOD_SETTING = "Period";
    private static final int DEFAULT_PERIOD = 20;
    private static final double UPPER_LEVEL = 100;
    private static final double LOWER_LEVEL = -100;
    private static final double ZERO_LINE = 0;
    private static final Color CCI_COLOR = Color.web("#26a69a");
    ...
    public SubChartResult compute(Bars bars, Map<String, Object> settings) {
        ...
        float[] raw = IndicatorFunctions.cci(
                a.high(), a.low(), a.close(), size, period);
        double[] values = toDouble(raw, size);
        String label = INDICATOR_NAME + "(" + period + ")";
        return new SubChartResult(values, CCI_COLOR, label, true, List.of(),
                null, null, null, ZERO_LINE, UPPER_LEVEL, LOWER_LEVEL);
    }
