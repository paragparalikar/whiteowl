...
public final class WhiteOwlApp extends Application {
    ...
    private static final String PIN_PROP = "kite.pin";
    ...
    private Context createContext() {
        Supplier<KiteCredentials> credentialsSupplier = () -> KiteCredentials.builder()
                .portfolioId(System.getProperty(PORTFOLIO_ID_PROP))
                .username(System.getProperty(USERNAME_PROP))
                .password(System.getProperty(PASSWORD_PROP))
                .pin(System.getProperty(PIN_PROP))
                .build();
        return new Context(credentialsSupplier, System.getProperty(PORTFOLIO_ID_PROP));
    }
