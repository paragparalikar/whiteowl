...
public final class NarrowRangeDayScreen implements Screen {

    private static final String NAME = "Narrow Range Day";
    private static final String SETTING_PERIOD = "ATR Period";
    private static final String SETTING_THRESHOLD = "Range / ATR Threshold";
    ...
    public boolean matches(Scrip scrip, Bars bars) {
        ...
        float todayRange = bars.getHigh(size - 1) - bars.getLow(size - 1);
        return todayRange < atr * threshold;
    }
