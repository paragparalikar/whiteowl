...
final class BarDataVerifier {
    ...
    List<KiteCandle> verify(String scripId, Timeframe timeframe, List<KiteCandle> candles) throws InvalidBarDataException {
        verifyAgainstPersistedData(scripId, timeframe, candles);
        return verifyDownloadedData(scripId, timeframe, candles);
    }

    private void verifyAgainstPersistedData(String scripId, Timeframe timeframe, List<KiteCandle> candles)
    ...
    private List<KiteCandle> verifyDownloadedData(String scripId, Timeframe timeframe, List<KiteCandle> candles)
            throws InvalidBarDataException {
