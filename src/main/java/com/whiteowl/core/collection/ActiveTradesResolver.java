...
public final class ActiveTradesResolver {
    ...
    private Set<String> resolveFromAdapter(KiteBrokerAdapter adapter, Set<String> selectedNames) {
    ...
    private void collectHoldings(KiteBrokerAdapter adapter, Set<String> ids) {
        try {
    ...
    private void collectPositions(KiteBrokerAdapter adapter, Set<String> ids) {
        try {
